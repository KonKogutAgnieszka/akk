...
export default function SnakePath({ onComplete }: { onComplete?: () => void }) {
  ...
  useEffect(() => {
    ...
    function animate() {
      ...
      if (Math.abs(diff) > 0.0001) {
        ...
        const point = path.getPointAtLength(currentProgress.current * totalLength);
  ...
  return (
    ...
    >
      <path
        ...
        d="M294.813 1.4
H974
A160 160 0 0 1 974 321.4
H102
A160 160 0 0 0 102 641.4
H974
A160 160 0 0 1 974 961.4
H102
A160 160 0 0 0 102 1281.4
H974
